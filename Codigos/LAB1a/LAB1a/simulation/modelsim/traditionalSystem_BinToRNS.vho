...
SIGNAL \converter:add_2n_p1|S[2]~12_combout\ : std_logic;
SIGNAL \converter:add_2n_p1|c~1_combout\ : std_logic;
SIGNAL \converter:add_2n_p1|c~2_combout\ : std_logic;
...
SIGNAL \converter:add_2n_p1|c\ : std_logic_vector(5 DOWNTO 0);
...
-- Equation(s):
-- \converter:comp0_2n_m1|ciclo:1:add|Cout~0_combout\ = (\SW~combout\(9) & ((\SW~combout\(5)) # (\SW~combout\(1)))) # (!\SW~combout\(9) & (\SW~combout\(5) & \SW~combout\(1)))
...
-- Equation(s):
-- \converter:add_2n_m1|g~2_combout\ = (\converter:comp1_2n_m1|ciclo:2:add|S~combout\ & (!\converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ & (\converter:comp1_2n_m1|ciclo:3:add|S~combout\ $ (\converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\)))) # 
-- (!\converter:comp1_2n_m1|ciclo:2:add|S~combout\ & (\converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ & (\converter:comp1_2n_m1|ciclo:3:add|S~combout\ $ (\converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\))))
...
-- Equation(s):
-- \converter:comp0_2n_p1|ciclo:1:add|Cout~0_combout\ = (\SW~combout\(9) & ((\SW~combout\(1)) # (!\SW~combout\(5)))) # (!\SW~combout\(9) & (!\SW~combout\(5) & \SW~combout\(1)))
...
-- Equation(s):
-- \converter:comp0_2n_p1|ciclo:3:add|S~0_combout\ = \SW~combout\(11) $ (\SW~combout\(7) $ (\SW~combout\(3)))
...
-- Equation(s):
-- \converter:comp0_2n_p1|ciclo:1:add|S~0_combout\ = \SW~combout\(9) $ (\SW~combout\(5) $ (\SW~combout\(1)))
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:1:add|Cout~0_combout\ = (\SW~combout\(13) & (\converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\ & (\SW~combout\(9) $ (!\converter:comp0_2n_m1|ciclo:1:add|S~0_combout\)))) # (!\SW~combout\(13) & 
-- ((\converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\) # (\SW~combout\(9) $ (!\converter:comp0_2n_m1|ciclo:1:add|S~0_combout\))))
...
PORT MAP (
	...
	datad => \converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\,
...
-- Equation(s):
-- \converter:comp0_2n_m1|ciclo:3:add|Cout~0_combout\ = (\SW~combout\(11) & ((\SW~combout\(7)) # (\SW~combout\(3)))) # (!\SW~combout\(11) & (\SW~combout\(7) & \SW~combout\(3)))
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:0:add|S~combout\ = \SW~combout\(12) $ (\SW~combout\(8) $ (\converter:comp0_2n_m1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp0_2n_m1|ciclo:0:add|S~0_combout\)))
...
PORT MAP (
	dataa => \SW~combout\(12),
	datab => \SW~combout\(8),
	datac => \converter:comp0_2n_m1|ciclo:3:add|Cout~0_combout\,
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\ = (\SW~combout\(15) & ((\converter:comp0_2n_m1|ciclo:2:add|Cout~0_combout\) # (\SW~combout\(11) $ (\converter:comp0_2n_m1|ciclo:3:add|S~0_combout\)))) # (!\SW~combout\(15) & 
-- (\converter:comp0_2n_m1|ciclo:2:add|Cout~0_combout\ & (\SW~combout\(11) $ (\converter:comp0_2n_m1|ciclo:3:add|S~0_combout\))))
...
-- Equation(s):
-- \converter:add_2n_m1|c~0_combout\ = (\converter:comp1_2n_m1|ciclo:1:add|S~combout\ & (!\converter:comp1_2n_m1|ciclo:0:add|Cout~0_combout\ & (\converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_m1|ciclo:0:add|S~combout\)))) # 
-- (!\converter:comp1_2n_m1|ciclo:1:add|S~combout\ & (\converter:comp1_2n_m1|ciclo:0:add|Cout~0_combout\ & (\converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_m1|ciclo:0:add|S~combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:comp1_2n_m1|ciclo:1:add|S~combout\,
	datab => \converter:comp1_2n_m1|ciclo:0:add|Cout~0_combout\,
	datac => \converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\,
...
-- Equation(s):
-- \converter:add_2n_m1|p[11]~0_combout\ = (\converter:add_2n_m1|g~2_combout\ & \converter:add_2n_m1|c~0_combout\)
...
PORT MAP (
	...
	datad => \converter:add_2n_m1|c~0_combout\,
...
-- Equation(s):
-- \converter:comp0_2n_m1|ciclo:0:add|Cout~0_combout\ = (\SW~combout\(8) & ((\SW~combout\(4)) # (\SW~combout\(0)))) # (!\SW~combout\(8) & (\SW~combout\(4) & \SW~combout\(0)))
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ = (\SW~combout\(13) & ((\converter:comp0_2n_m1|ciclo:0:add|Cout~0_combout\) # (\SW~combout\(9) $ (\converter:comp0_2n_m1|ciclo:1:add|S~0_combout\)))) # (!\SW~combout\(13) & 
-- (\converter:comp0_2n_m1|ciclo:0:add|Cout~0_combout\ & (\SW~combout\(9) $ (\converter:comp0_2n_m1|ciclo:1:add|S~0_combout\))))
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:3:add|S~combout\ = \SW~combout\(11) $ (\converter:comp0_2n_m1|ciclo:3:add|S~0_combout\ $ (\SW~combout\(15) $ (\converter:comp0_2n_m1|ciclo:2:add|Cout~0_combout\)))
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\ = (\converter:comp0_2n_m1|ciclo:1:add|Cout~0_combout\ & ((\SW~combout\(14)) # (\SW~combout\(10) $ (\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\)))) # 
-- (!\converter:comp0_2n_m1|ciclo:1:add|Cout~0_combout\ & (\SW~combout\(14) & (\SW~combout\(10) $ (\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\))))
...
-- Equation(s):
-- \converter:add_2n_m1|g[7]~0_combout\ = (\converter:comp1_2n_m1|ciclo:3:add|S~combout\ & ((\converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\) # ((\converter:comp1_2n_m1|ciclo:2:add|S~combout\ & \converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\)))) # 
-- (!\converter:comp1_2n_m1|ciclo:3:add|S~combout\ & (\converter:comp1_2n_m1|ciclo:2:add|S~combout\ & (\converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ & \converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\)))
...
-- Equation(s):
-- \converter:add_2n_m1|S\(0) = \converter:comp1_2n_m1|ciclo:0:add|S~combout\ $ (\converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\ $ (((\converter:add_2n_m1|p[11]~0_combout\) # (\converter:add_2n_m1|g\(11)))))
...
PORT MAP (
	...
	datab => \converter:add_2n_m1|p[11]~0_combout\,
	datac => \converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\,
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:1:add|S~combout\ = \SW~combout\(9) $ (\SW~combout\(13) $ (\converter:comp0_2n_m1|ciclo:1:add|S~0_combout\ $ (\converter:comp0_2n_m1|ciclo:0:add|Cout~0_combout\)))
...
-- Equation(s):
-- \converter:add_2n_m1|c[1]~1_combout\ = (\converter:comp1_2n_m1|ciclo:0:add|S~combout\ & ((\converter:add_2n_m1|p[11]~0_combout\) # ((\converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\) # (\converter:add_2n_m1|g\(11))))) # 
-- (!\converter:comp1_2n_m1|ciclo:0:add|S~combout\ & (\converter:comp1_2n_m1|ciclo:3:add|Cout~0_combout\ & ((\converter:add_2n_m1|p[11]~0_combout\) # (\converter:add_2n_m1|g\(11)))))
...
-- Equation(s):
-- \converter:add_2n_m1|c~2_combout\ = (\converter:add_2n_m1|c~0_combout\ & ((\converter:add_2n_m1|g~2_combout\) # (\converter:add_2n_m1|g[7]~0_combout\)))
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:2:add|S~combout\ = \converter:comp0_2n_m1|ciclo:1:add|Cout~0_combout\ $ (\SW~combout\(14) $ (\SW~combout\(10) $ (\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\)))
...
-- Equation(s):
-- \converter:add_2n_m1|S\(2) = \converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ $ (\converter:comp1_2n_m1|ciclo:2:add|S~combout\ $ (((\converter:add_2n_m1|g[9]~1_combout\) # (\converter:add_2n_m1|c~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:add_2n_m1|g[9]~1_combout\,
...
-- Equation(s):
-- \converter:comp1_2n_m1|ciclo:2:add|S~2_combout\ = \converter:comp0_2n_m1|ciclo:1:add|Cout~0_combout\ $ (\SW~combout\(6) $ (\SW~combout\(10) $ (\SW~combout\(2))))
...
-- Equation(s):
-- \converter:add_2n_m1|g[10]~3_combout\ = (\converter:add_2n_m1|g[9]~1_combout\ & ((\converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\) # (\SW~combout\(14) $ (\converter:comp1_2n_m1|ciclo:2:add|S~2_combout\)))) # (!\converter:add_2n_m1|g[9]~1_combout\ & 
-- (\converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\ & (\SW~combout\(14) $ (\converter:comp1_2n_m1|ciclo:2:add|S~2_combout\))))
...
PORT MAP (
	...
	datab => \converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\,
	datac => \SW~combout\(14),
	datad => \converter:comp1_2n_m1|ciclo:2:add|S~2_combout\,
...
PORT MAP (
	...
	datab => \converter:add_2n_m1|c~2_combout\,
	datac => \converter:comp1_2n_m1|ciclo:1:add|Cout~0_combout\,
	datad => \converter:add_2n_m1|g[10]~3_combout\,
	combout => \converter:add_2n_m1|c\(3));

-- Location: LCCOMB_X36_Y1_N18
\converter:add_2n_m1|S[3]\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_m1|S\(3) = \converter:add_2n_m1|c\(3) $ (\converter:comp1_2n_m1|ciclo:3:add|S~combout\ $ (\converter:comp1_2n_m1|ciclo:2:add|Cout~0_combout\))
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:2:add|Cout~0_combout\ = (\converter:comp0_2n_p1|ciclo:1:add|Cout~0_combout\ & ((\SW~combout\(10) $ (!\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\)) # (!\SW~combout\(14)))) # 
-- (!\converter:comp0_2n_p1|ciclo:1:add|Cout~0_combout\ & (!\SW~combout\(14) & (\SW~combout\(10) $ (!\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:comp0_2n_p1|ciclo:3:add|S~0_combout\,
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ = (\SW~combout\(15) & (\converter:comp0_2n_p1|ciclo:2:add|Cout~0_combout\ & (\SW~combout\(11) $ (!\converter:comp0_2n_m1|ciclo:3:add|S~0_combout\)))) # (!\SW~combout\(15) & 
-- ((\converter:comp0_2n_p1|ciclo:2:add|Cout~0_combout\) # (\SW~combout\(11) $ (!\converter:comp0_2n_m1|ciclo:3:add|S~0_combout\))))
...
-- Equation(s):
-- \converter:comp0_2n_p1|ciclo:3:add|Cout~0_combout\ = (\SW~combout\(11) & ((\SW~combout\(3)) # (!\SW~combout\(7)))) # (!\SW~combout\(11) & (!\SW~combout\(7) & \SW~combout\(3)))
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:0:add|Cout~0_combout\ = (\SW~combout\(12) & (!\converter:comp0_2n_p1|ciclo:3:add|Cout~0_combout\ & (\SW~combout\(8) $ (!\converter:comp0_2n_m1|ciclo:0:add|S~0_combout\)))) # (!\SW~combout\(12) & ((\SW~combout\(8) $ 
-- (!\converter:comp0_2n_m1|ciclo:0:add|S~0_combout\)) # (!\converter:comp0_2n_p1|ciclo:3:add|Cout~0_combout\)))
...
PORT MAP (
	dataa => \SW~combout\(12),
	datab => \SW~combout\(8),
	datac => \converter:comp0_2n_p1|ciclo:3:add|Cout~0_combout\,
	datad => \converter:comp0_2n_m1|ciclo:0:add|S~0_combout\,
...
-- Equation(s):
-- \converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\ = (\SW~combout\(8) & ((\SW~combout\(0)) # (!\SW~combout\(4)))) # (!\SW~combout\(8) & (!\SW~combout\(4) & \SW~combout\(0)))
...
-- Equation(s):
-- \converter:comp2_2n_p1|ciclo:1:add|S~combout\ = \converter:comp0_2n_p1|ciclo:1:add|S~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|Cout~0_combout\ $ (\SW~combout\(13) $ (\converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:comp0_2n_p1|ciclo:1:add|S~0_combout\,
	datab => \converter:comp1_2n_p1|ciclo:0:add|Cout~0_combout\,
	datac => \SW~combout\(13),
	datad => \converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\,
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:0:add|S~combout\ = \SW~combout\(12) $ (\SW~combout\(8) $ (\converter:comp0_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp0_2n_m1|ciclo:0:add|S~0_combout\)))
...
-- Equation(s):
-- \converter:add_2n_p1|p[11]~0_combout\ = (\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & (\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|S~combout\)))) # 
-- (!\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & ((\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ & (\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & \converter:comp1_2n_p1|ciclo:0:add|S~combout\)) # 
-- (!\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ & (!\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & !\converter:comp1_2n_p1|ciclo:0:add|S~combout\))))
...
PORT MAP (
	...
	datac => \converter:comp2_2n_p1|ciclo:1:add|S~combout\,
...
-- Equation(s):
-- \converter:comp2_2n_p1|ciclo:1:add|Cout~0_combout\ = (\converter:comp1_2n_p1|ciclo:0:add|Cout~0_combout\ & (\converter:comp0_2n_p1|ciclo:1:add|S~0_combout\ $ (\SW~combout\(13) $ (\converter:comp0_2n_p1|ciclo:0:add|Cout~0_combout\))))
...
-- Equation(s):
-- \converter:comp2_2n_p1|ciclo:3:add|S~combout\ = \converter:comp0_2n_p1|ciclo:3:add|S~0_combout\ $ (\converter:comp1_2n_p1|ciclo:2:add|Cout~0_combout\ $ (\SW~combout\(15) $ (\converter:comp0_2n_p1|ciclo:2:add|Cout~0_combout\)))
...
-- Equation(s):
-- \converter:comp1_2n_p1|ciclo:2:add|S~combout\ = \converter:comp0_2n_p1|ciclo:1:add|Cout~0_combout\ $ (\SW~combout\(14) $ (\SW~combout\(10) $ (\converter:comp0_2n_m1|ciclo:2:add|S~0_combout\)))
...
-- Equation(s):
-- \converter:add_2n_p1|S\(0) = \converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:add_2n_p1|c[0]~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|S~combout\)))
...
PORT MAP (
	dataa => \converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\,
	datab => \converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\,
	datac => \converter:add_2n_p1|c[0]~0_combout\,
	datad => \converter:comp1_2n_p1|ciclo:0:add|S~combout\,
...
-- Equation(s):
-- \converter:add_2n_p1|c\(1) = (\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & (\converter:add_2n_p1|c[0]~0_combout\ & (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|S~combout\)))) # 
-- (!\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & ((\converter:add_2n_p1|c[0]~0_combout\) # (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|S~combout\))))
...
PORT MAP (
	...
	datac => \converter:add_2n_p1|c[0]~0_combout\,
	datad => \converter:comp1_2n_p1|ciclo:0:add|S~combout\,
	combout => \converter:add_2n_p1|c\(1));

-- Location: LCCOMB_X34_Y1_N16
\converter:add_2n_p1|S[1]\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_p1|S\(1) = \converter:add_2n_p1|c\(1) $ (\converter:comp2_2n_p1|ciclo:1:add|S~combout\ $ (((\converter:comp1_2n_p1|ciclo:0:add|S~combout\) # (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\))))
...
\converter:add_2n_p1|S[2]~12\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_p1|S[2]~12_combout\ = (\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & ((\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (!\converter:comp1_2n_p1|ciclo:0:add|S~combout\)) # (!\converter:comp2_2n_p1|ciclo:1:add|S~combout\))) # 
...
PORT MAP (
	...
	datac => \converter:comp2_2n_p1|ciclo:1:add|S~combout\,
	datad => \converter:comp1_2n_p1|ciclo:0:add|S~combout\,
	combout => \converter:add_2n_p1|S[2]~12_combout\);

-- Location: LCCOMB_X34_Y1_N14
\converter:add_2n_p1|S[2]\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_p1|S\(2) = \converter:add_2n_p1|p[6]~2_combout\ $ (((\converter:add_2n_p1|g[9]~0_combout\) # ((!\converter:add_2n_p1|S[2]~12_combout\ & \converter:add_2n_p1|c[0]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:add_2n_p1|p[6]~2_combout\,
	datab => \converter:add_2n_p1|S[2]~12_combout\,
	datac => \converter:add_2n_p1|c[0]~0_combout\,
...
\converter:add_2n_p1|c~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_p1|c~1_combout\ = (\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & (\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & (\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ $ (\converter:comp1_2n_p1|ciclo:0:add|S~combout\)))) # 
-- (!\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\ & ((\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ & (\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & \converter:comp1_2n_p1|ciclo:0:add|S~combout\)) # 
-- (!\converter:comp1_2n_p1|ciclo:3:add|Cout~0_combout\ & (!\converter:comp2_2n_p1|ciclo:1:add|S~combout\ & !\converter:comp1_2n_p1|ciclo:0:add|S~combout\))))
...
\converter:add_2n_p1|c~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \converter:add_2n_p1|c~2_combout\ = (\converter:add_2n_p1|c[0]~0_combout\ & (\converter:add_2n_p1|c~1_combout\ & ((\converter:comp2_2n_p1|ciclo:1:add|S~combout\) # (!\converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\))))
...
PORT MAP (
	dataa => \converter:comp2_2n_p1|ciclo:3:add|Cout~0_combout\,
	datab => \converter:comp2_2n_p1|ciclo:1:add|S~combout\,
	datac => \converter:add_2n_p1|c[0]~0_combout\,
	datad => \converter:add_2n_p1|c~1_combout\,
	combout => \converter:add_2n_p1|c~2_combout\);
...
PORT MAP (
	dataa => \converter:comp1_2n_p1|ciclo:1:add|Cout~0_combout\,
	datab => \converter:comp2_2n_p1|ciclo:3:add|S~combout\,
	datad => \converter:comp1_2n_p1|ciclo:2:add|S~combout\,
...
-- Equation(s):
-- \converter:add_2n_p1|S\(3) = \converter:add_2n_p1|p\(3) $ (((\converter:add_2n_p1|g[10]~2_combout\) # ((\converter:add_2n_p1|p[6]~2_combout\ & \converter:add_2n_p1|c~2_combout\))))
...
PORT MAP (
	dataa => \converter:add_2n_p1|p[6]~2_combout\,
	datab => \converter:add_2n_p1|c~2_combout\,
	datac => \converter:add_2n_p1|g[10]~2_combout\,
	datad => \converter:add_2n_p1|p\(3),
...
-- pragma translate_on
PORT MAP (
	dataa => \converter:add_2n_p1|p[11]~0_combout\,
